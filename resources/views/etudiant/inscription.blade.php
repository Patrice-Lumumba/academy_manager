...
<head>
    ...
    <title><?php $title = "Inscription"; ?></title>
        ...
        <div class="card-body">
            ...
            <form action="etudiant/save" method="post" class="mt-3">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="tel_etud" id="tel_etud" placeholder="Ex: 655436213" maxlength="9" class="form-group">
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-3">
                        <input type="mail" name="mail_etud" id="mail_etud" placeholder="Ex: test@xyz.com" class="form-group">
                    </div>
                </div>

                <div class="row mt-2">
                    <div class="col-sm-3">
                        <label for="annee_etud">Année étude: </label>
                    </div>
                    <div class="col-sm-3">
                        <input type="number" name="annee_etud" id="annee_etud" placeholder="Ex: 1960" class="form-group">
                    </div>
                </div>
